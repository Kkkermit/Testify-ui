...
const Landing: React.FC = () => {
	return (
		<div className="flex h-screen justify-center items-center dark:bg-slate-700" data-testid="landing-page">
				...
				<div className="text-center ">
					<h1 className="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200 sm:text-5xl md:text-6xl">
						<span className="block xl:inline">
							<span className="mb-1 block">{i18n.t("landing.startHeading")}</span>
							<span className="bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent">
								{i18n.t("landing.middleHeading")}
							</span>
						</span>
						<div className="mt-2">
							{i18n.t("landing.middleHeading2")}{" "}
							<span className="relative mt-3 whitespace-nowrap text-blue-600">
								...
								<span className="relative">{i18n.t("landing.endHeading")}</span>
							</span>
						</div>
					</h1>
